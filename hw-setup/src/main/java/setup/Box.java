...
public class Box implements Iterable<Ball> {
    ...
    public Iterator<Ball> getBallsFromSmallest() {
        TreeSet<Ball> ballTreeSet = new TreeSet<>(new BallComparator());
        Iterator<Ball> it = iterator();
        while(it.hasNext()) {
            Ball temp = it.next();
            ballTreeSet.add(temp);
        }
        return ballTreeSet.iterator();
    }
    ...
    /**
     * This is a Comparator to compare two balls
     */
    public class BallComparator implements Comparator<Ball> {
        /**
         * This is a compare method that compare the volume of two balls
         *
         * @param b1 and b2 Balls to be compared
         * @return the compared result of volume
         */
